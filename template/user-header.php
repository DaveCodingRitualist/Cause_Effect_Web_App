    ...
    <body class="sb-nav-fixed my-bg " >
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark text-muted " >
            <!-- Navbar Brand-->
            <a class="navbar-brand bold text-muted ms-4" href="#">CAUSE <span style="color: brown;">|</span> ƎFFECT</a>
            <!-- Sidebar Toggle-->
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="add-recipes.php">Add Recipes</a>
                                    <a class="nav-link" href="recipes.php">Master Recipes</a>
                                </nav>
                            </div>
