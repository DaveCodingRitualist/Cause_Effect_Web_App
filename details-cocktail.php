...
if(isset($_POST['delete'])){
    ...
    $sql = "DELETE FROM recipes2 WHERE id = $id_to_delete";
...
if(isset($_GET['id'])){
    ...
    //make sql
    $sql = "SELECT * FROM recipes2 WHERE id = $id";
...
<html lang="en">
    ...
    <?php if($recipe): ?>
        <h4><?php echo htmlspecialchars($recipe['cocktail']); ?></h4>
        <p>created at: <?php echo date($recipe['updated_at']);?></p>
        <h5>Ingredients</h5>
        
        <p><?php echo htmlspecialchars($recipe['ingredients'])?></p>
        <h5>Method</h5>
        <p><?php echo htmlspecialchars($recipe['metho'])?></p>
    
        <!-- DELETE FORM -->
        <form action="details-cocktail.php" method="POST">
