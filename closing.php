...
<div class="modal fade pt-5 mt-2" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog ">
    <div class="modal-content  text-muted">
      ...
      <div class="input-group mb-3">
                     <span class="input-group-text bg-danger text-white" id="basic-addon1"><i class="material-icons">person</i></span>
                    <input type="text" class="form-control bg-light text-muted " name="station-one" placeholder="Station One " aria-label="item" aria-describedby="basic-addon1">
                    </div>
      <div class="input-group mb-3">
                     <span class="input-group-text bg-danger text-white" id="basic-addon1"><i class="material-icons">person</i></span>
                    <input type="text" class="form-control bg-light text-muted " name="station-two" placeholder="Station Two" aria-label="item" aria-describedby="basic-addon1">
                    </div>
      <div class="input-group mb-3">
                     <span class="input-group-text bg-danger text-white" id="basic-addon1"><i class="material-icons">person</i></span>
                    <input type="text" class="form-control bg-light text-muted " name="station-three" placeholder="Station Three" aria-label="item" aria-describedby="basic-addon1">
                    </div>
      <div class="input-group mb-3">
                     <span class="input-group-text bg-danger text-white" id="basic-addon1"><i class="material-icons">person</i></span>
      ...
      <div class="input-group mb-3">
                     <span class="input-group-text bg-danger text-white" id="basic-addon1"><i class="material-icons">person</i></span>
                    <input type="text" class="form-control bg-light text-muted " name="sculler" placeholder="Sculler" aria-label="item" aria-describedby="basic-addon1">
                    </div>              
</div>
      ...
      <button type="button" class="btn btn-secondary text-white " data-bs-dismiss="modal">Close</button>
        <button type="submit" name="saveteamnight" class="btn btn-primary" >Submit</button>
      </div>
      </form> 
    </div>
  </div>
...
<div class="modal fade pt-5 mt-2" id="exampleModal44" tabindex="-1" aria-labelledby="exampleModalLabel44" aria-hidden="true">
  ...
  <form id="paper" action="closing.php" method="POST">
     ...
     <div class="tab-content" id="myTabContent">
        ...
        >
            ...
            <div class=" table-data py-2 ">
              ...
              <form id="form" action="closing.php" method="POST" >
                    ...
                    <?php
                     ...
                     <?php
                      ...
                      if(!isset($_POST['ch_'.$i])){
                        $sql="UPDATE bartender_night SET complete = 'Not Done' WHERE id = '$id'";
                    } else {
                        $sql="UPDATE bartender_night SET complete = 'Done' WHERE id = '$id'";
                    } 
              ...
              <tbody id="tbody">  
                  ...
                  <?php
                   ...
                   <?php
                    ...
                    if(!isset($_POST['ch_'.$i])){
                      $sql="UPDATE barback_night SET complete = 'Not Done' WHERE id = '$id'";
                  } else {
                      $sql="UPDATE barback_night SET complete = 'Done' WHERE id = '$id'";
                  } 
        ...
        <!-- OPENING PROCEDURE PAGE -->
            ...
            <div class="jumbotron bg-dark ">
                <div class="card bg-dark">
                     <h2 class="py-2 text-light bg-dark text-muted rounded " ><i class="fa-solid fa-calendar-check display-5"></i> Closing Procedure</h2>
                </div>
                <div class="card bg-dark">
                    <div class="card-body ">
                    ...
                    <div class="card-body">
                    <button type="button" class="btn  btn-warning  ms-1 fw-bold" data-bs-toggle="modal" data-bs-target="#exampleModal3"><i class="fa-solid fa-list-check"></i> Duties Checklist</button>
                    </div>
                    <div class="card-body">
                    <button type="button" class="btn btn-info ms-1 fw-bold"  data-bs-toggle="modal" data-bs-target="#exampleModal4" ><i class="fa-solid fa-money-bills"></i>  Float close</button>
                    </div>
                    <div class="card-body">
